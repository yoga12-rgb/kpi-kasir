-- ============================================================
-- 0037_atomic_mentoring_session.sql
--
-- M3.3: mentoring session dan seluruh cashier note atomik.
-- ============================================================
...
begin
  ...
  loop
    if jsonb_typeof(v_note) <> 'object'
      ...
      or not (v_note ? 'note')
      or not ((v_note->>'cashierId') ~* '^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$')
